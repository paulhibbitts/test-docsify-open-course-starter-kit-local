...
> This is a starter kit to create an open [Docsify](https://docsify.js.org) course site. To address possible privacy/GDPR concerns all needed css/js files are loaded locally and not via CDN.
